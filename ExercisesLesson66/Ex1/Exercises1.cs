    ...
    static class EmployeeUtils
    {
        ...
        public static void DisplayEmployees(Employee[] employees)
        {
            ...
            foreach (var item in employees)
            {
                if (item != null)
                {
                    Console.WriteLine($"{item.Id,-15:d}{item.Name,-25:d}{item.PhoneNumber[0],-15:d}" +
        ...
        // tính tổng lương các nhân viên có trong danh sách
        public static float TotalSalary(Employee[] employees)
        {
            float total = 0;
        ...
        public static Employee[] FindBySalary(Employee[] employees, float salary)
        {
    ...
    class Exercises1
    {
        static void Main()
        {
            ...
            do
            {
                ...
                Console.WriteLine("= 7. Tìm và hiển thị thông tin nhân viên theo mức lương.       =");
                Console.WriteLine("= 8. Cập nhật mức lương cho nhân viên theo mã nhân viên.       =");
                Console.WriteLine("= 9. Xóa bỏ nhân viên theo mã nhân viên.                       =");
                Console.WriteLine("= 10. Tính tổng lương của các nhân viên trong danh sách.       =");
                ...
                switch (choice)
                {
                    ...
                    case 7:
                        if (size > 0)
                        {
                            Console.WriteLine("Nhập mức lương cần tìm: ");
                            float salary = float.Parse(Console.ReadLine());
                            var result = EmployeeUtils.FindBySalary(employees, salary);
                            if (result[0] == null)
                            {
                            ...
                            {
                                Console.WriteLine($"==> Các nhân viên có mức lương {salary}<==");
                                EmployeeUtils.DisplayEmployees(result);
                            }
                        }
                        else
                        {
                    ...
                    case 10:
                        if (size > 0)
                        {
                            var result = EmployeeUtils.TotalSalary(employees);
                            Console.WriteLine($"Tổng lương các nhân viên có trong danh sách: {result + ""}");
                        }
                        else
                        {
                            Console.WriteLine("==> Danh sách nhân viên rỗng <==");
